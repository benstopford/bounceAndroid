...
public class LoginActivity extends Activity implements QBCallback {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		mPhoneNumber = Utils.standartPhoneNumber(mPhoneNumber);
	...
	public void onLoginButtonClick(View v) {
		...
		username = Utils.standartPhoneNumber(username);
		Log.d(TAG, "on login username phone number is " + username);
	...
	private void registerNewUser() {
		...
		username = Utils.standartPhoneNumber(username);
		Log.d(TAG, "on register username phone number is " + username);
